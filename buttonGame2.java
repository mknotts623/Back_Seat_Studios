...
public class buttonGame2 extends JFrame {
    ...
    public static int p1HP = 50;
    public static int p2HP = 50;
    static int maxMana = 1;
    static int p1Mana = 1;
    static int p2Mana = 1;

    public static int maxCards = 1;
    ...
    public static void drawBoard() {
        maxCards = getNumb("Select the length of your game.");
        if(maxCards == 0){
            maxCards = 20;
            p1HP = 50;
            p2HP = 50;
    ...
    public static int getNumb(String optionText){//Receives the length of the game by the player's choice
        Object[] options = {"Short", "Medium", "Long"};
        int optionResult = JOptionPane.showOptionDialog (null, optionText, "Input Window",
                JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
        return optionResult;
    }

    public static int playAgain(String optionText){//gives the player the option to play again
    ...
    public static void disPlay(String s) {//Used only for displaying JOptionPane messages.
        JOptionPane.showMessageDialog(null, s);
    }
    
    public static void waitMSec(int period) //Makes the program stall for (period) milliseconds. Why? Beats me.
    {
        try 
        {
            Thread.sleep(period);                 
