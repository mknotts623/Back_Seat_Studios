...
public class CardDatabase
{
    ...
    public static Card CardDatabase(int n) {
        ...
        database[1] = new Card("Slime", 3, 1, 5, 1, "Slime.png");
        ...
        database[3] = new Card("Awarewolf", 7, 3, 7, 2,"Awarewolf.png");//image not done
        ...
        database[4] = new Card("Grumpy Gargoyle", 11, 9, 9, 4, "GrumpyGargoyle.png");//image not done
        ...
        database[5] = new Card("Grand Slampire", 14, 13, 9, 5, "Grand Slampire.png");
        database[6] = new Card("Raven Wraith", 15, 13, 13, 6, "RavenWraith.png");
        database[7] = new Card("The CARE^2", 16, 15, 11, 6, "Care2.png");
